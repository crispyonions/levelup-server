...
class GameTests(APITestCase):
    ...
    def test_get_game(self):
        ...
        game = Game()
        game.game_type = GameType.objects.get(pk=1)
        game.skill_level = 5
        game.title = "Monopoly"
    ...
    def test_delete_game(self):
        ...
        """
        game = Game()
        game.game_type = GameType.objects.get(pk=2)
        game.skill_level = "Beginner to intermediate."
        game.title = "Settlers of Catan"
        game.maker = "Klaus Teubur"
        game.number_of_players = "3-4 (up to 6 with expansion)"
        game.gamer_id = 1
        game.save()
